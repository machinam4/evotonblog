                    ...
                    <div class="content-block post-grid post-grid-transparent">
                        ...
                        <div class="post-grid-content">
                            <div class="post-content">
                                ...
                                <h3 class="title"><a href="post-details.html">Beauty of deep space.
                                        Billions of
                ...
                <div class="col-xl-3 col-md-6 mt_lg--30 mt_md--30 mt_sm--30 col-12">
                    ...
                    <div class="content-block image-rounded">
                        ...
                        <div class="post-content pt--20">
                            ...
                            <h5 class="title"><a href="post-details.html">Rocket Lab mission fails shortly
                                    after
                                    launch</a></h5>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-md-6 mt_lg--30 mt_md--30 mt_sm--30 col-12">
                    ...
                    <div class="content-block image-rounded mt--30">
                        ...
                        <div class="post-content pt--20">
                            ...
                            <h5 class="title"><a href="post-details.html">Air Pods Pro with Wireless
                                    Charging
                                    Case.</a></h5>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <ul class="axil-tab-button nav nav-tabs mt--20" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="grid-one" data-bs-toggle="tab" href="#gridone" role="tab"
                                aria-controls="grid-one" aria-selected="true">Accessibility</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="grid-two" data-bs-toggle="tab" href="#gridtwo" role="tab"
                                aria-controls="grid-two" aria-selected="false">Android Dev</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="grid-three" data-bs-toggle="tab" href="#gridthree" role="tab"
                                aria-controls="grid-three" aria-selected="false">Blockchain</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="grid-four" data-bs-toggle="tab" href="#gridfour" role="tab"
                                aria-controls="grid-four" aria-selected="false">Gadgets</a>
                        </li>
                    </ul>
                    <!-- Start Tab Content  -->
                                ...
                                <div class="col-xl-5 col-lg-6 col-md-12 col-12">
                                    ...
                                    <div class="content-block post-medium post-medium-border border-thin">
                                        ...
                                        <div class="post-content">
                                            ...
                                            <h4 class="title"><a href="post-details.html">OnePlus Nord
                                                    hands-on: Strong features at a tempting price</a></h4>
                                        </div>
                                    </div>
                                    <!-- End Post Medium  -->
                                    ...
                                    <div class="content-block post-medium post-medium-border border-thin">
                                        ...
                                        <div class="post-content">
                                            ...
                                            <h4 class="title"><a href="post-details.html">The best
                                                    accessories for your new iPad</a></h4>
                                        </div>
                                    </div>
                                    <!-- End Post Medium  -->
                                    ...
                                    <div class="content-block post-medium post-medium-border border-thin">
                                        ...
                                        <div class="post-content">
                                            ...
                                            <h4 class="title"><a href="post-details.html">Chinese EV
                                                    startups Byton and Nio received paycheck </a></h4>
                                        </div>
                                    </div>
                                    <!-- End Post Medium  -->
                                    ...
                                    <div class="content-block post-medium post-medium-border border-thin">
                                        ...
                                        <div class="post-content">
                                            ...
                                            <h4 class="title"><a href="post-details.html">How to
                                                    personalize your Google Chrome homepage with GIF</a></h4>
                                        </div>
                                    </div>
                                    <!-- End Post Medium  -->
                                    ...
                                    <div class="content-block content-block post-grid post-grid-transparent">
                                        ...
                                        <div class="post-grid-content">
                                            <div class="post-content">
                                                ...
                                                <h3 class="title"><a href="post-details.html">iPhone SE is
                                                        discontinued, but these retailers are still selling it</a>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-md-6 col-12">
                    ...
                    <div class="content-block post-default image-rounded mt--30">
                        ...
                        <div class="post-content">
                            ...
                            <h3 class="title"><a href="post-details.html">Security isn’t just a technology
                                    problem
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="content-block post-default image-rounded mt--30">
                                <div class="post-thumbnail">
                                    ...
                                    <a class="video-popup size-medium position-top-center" href="post-details.html"><span
                                            class="play-icon"></span></a>
                                </div>
                                <div class="post-content">
                                    <div class="post-cat">
                                    ...
                                    <h5 class="title"><a href="post-details.html">The 1 tool that helps
                                            remote teams
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="content-block post-default  image-rounded mt--30">
                                ...
                                <div class="post-content">
                                    ...
                                    <h5 class="title"><a href="post-details.html">Get Ready To Up Your
                                            Creative Game With The</a></h5>
                                </div>
                            </div>
                        </div>
                        <!-- End Post List  -->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="content-block post-default image-rounded mt--30">
                                ...
                                <div class="post-content">
                                    ...
                                    <h5 class="title"><a href="post-details.html">Traditional design won’t
                                            save us in the COVID-19 era</a></h5>
                                </div>
                            </div>
                        </div>
                        <!-- End Post List  -->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="content-block post-default image-rounded mt--30">
                                ...
                                <div class="post-content">
                                    ...
                                    <h5 class="title"><a href="post-details.html">New: Freehand Templates,
                                            built for the whole team</a></h5>
                                </div>
                            </div>
                        </div>
                        <!-- End Post List  -->
            ...
            <div class="row">
                <div class="col-lg-8 col-xl-8">
                    <div class="axil-banner">
                        <div class="thumbnail">
                            <a href="#">
                                <img class="w-100" src="assets/images/add-banner/banner-01.png"
                                    alt="Banner Images">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="content-block post-list-view is-active mt--30">
                        ...
                        <div class="post-content">
                            ...
                            <h4 class="title"><a href="post-details.html">New: Freehand Templates, built
                                    for the whole team</a></h4>
                            <div class="post-meta-wrapper">
                                <div class="post-meta">
                                    <div class="content">
                                        <h6 class="post-author-name">
                    ...
                    <div class="content-block post-list-view axil-control mt--30">
                        ...
                        <div class="post-content">
                            ...
                            <h4 class="title"><a href="post-details.html">Get Ready To Up Your Creative
                                    Game With The New DJI Mavic Air 2</a></h4>
                            <div class="post-meta-wrapper">
                                <div class="post-meta">
                                    <div class="content">
                                        <h6 class="post-author-name">
                    ...
                    <div class="content-block post-list-view axil-control mt--30">
                        ...
                        <div class="post-content">
                            ...
                            <h4 class="title"><a href="post-details.html">Traditional design won’t save us
                                    in the COVID-19 era</a></h4>
                            <div class="post-meta-wrapper">
                                <div class="post-meta">
                                    <div class="content">
                                        <h6 class="post-author-name">
                    ...
                    <div class="content-block post-list-view axil-control mt--30">
                        ...
                        <div class="post-content">
                            ...
                            <h4 class="title"><a href="post-details.html">One of the most portable drones
                                    in the market.</a></h4>
                            <div class="post-meta-wrapper">
                                <div class="post-meta">
                                    <div class="content">
                    ...
                    <div class="content-block post-list-view axil-control mt--30">
                        ...
                        <div class="post-content">
                            ...
                            <h4 class="title"><a href="post-details.html">The 1 tool that helps remote
                                    teams collaborate better</a></h4>
                            <div class="post-meta-wrapper">
                                <div class="post-meta">
                                    <div class="content">
                                        <h6 class="post-author-name">
                        ...
                        <div class="axil-single-widget widget widget_postlist mb--30">
                            ...
                            <div class="post-medium-block">
                                ...
                                <div class="content-block post-medium mb--20">
                                    ...
                                    <div class="post-content">
                                        <h6 class="title"><a href="post-details.html">The underrated
                                                design book that transformed the way I
                                                work </a></h6>
                                        <div class="post-meta">
                                            <ul class="post-meta-list">
                                                <li>Feb 17, 2019</li>
                                ...
                                <div class="content-block post-medium mb--20">
                                    ...
                                    <div class="post-content">
                                        <h6 class="title"><a href="post-details.html">Here’s what you
                                                should (and shouldn’t) do when</a>
                                        </h6>
                                        <div class="post-meta">
                                            <ul class="post-meta-list">
                                                <li>Feb 17, 2019</li>
    ...
    <div class="axil-review-area post-listview-visible-color axil-section-gap bg-color-grey">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <ul class="axil-tab-button nav nav-tabs mt--20" id="reviewTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="review-one" data-bs-toggle="tab" href="#reviewone" role="tab"
                                aria-controls="review-one" aria-selected="true">Phone</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="review-two" data-bs-toggle="tab" href="#reviewtwo" role="tab"
                                aria-controls="review-two" aria-selected="false">Laptops</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="review-three" data-bs-toggle="tab" href="#reviewthree" role="tab"
                                aria-controls="review-three" aria-selected="false">Headphones</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row tab-content">
                <div class="col-lg-12 tab-pane fade show active" id="reviewone" role="tabpanel"
                    ...
                    <div class="row">
                                    ...
                                    <div class="featured-post mt--30">
                                        <div class="content-block">
                                            <div class="post-content">
                                                ...
                                                <h4 class="title"><a href="post-details.html">Oppo Find X2
                                                        Pro Review: Supercar Smartphone</a></h4>
                                            </div>
                                            <div class="post-thumbnail">
                                                <a href="#">
                                                    <img src="assets/images/post-single/featured-post-01.jpg"
                                                        alt="Post Images">
                                    ...
                                    <div class="featured-post mt--30">
                                        <div class="content-block">
                                            <div class="post-content">
                                                ...
                                                <h4 class="title"><a href="post-details.html">The new Moto
                                                        G Stylus and G Power are surprisingly adept cameraphones</a>
                                                </h4>
                                            </div>
                                            <div class="post-thumbnail">
                                                <a href="#">
                                                    <img src="assets/images/post-single/featured-post-02.jpg"
                                                        alt="Post Images">
                                                    <div class="review-count">
                                                        <span>8</span>
                                                    </div>
                        ...
                        <div class="col-lg-8 col-xl-8 mt--30">
                            ...
                            <div class="content-block post-list-view with-bg-solid mt--30">
                                <div class="post-thumbnail">
                                    <a href="post-details.html">
                                        <img src="assets/images/post-images/post-tech-11.jpg" alt="Post Images">
                                        <div class="review-count">
                                            <span>7.4</span>
                                        </div>
                                    </a>
                                ...
                                <div class="post-content">
                                    ...
                                    <h4 class="title"><a href="post-details.html">Motorola Moto E (2020)
                                            and Moto G Fast review: smartphone basics</a></h4>
                                    <div class="post-meta-wrapper">
                                        <div class="post-meta">
                                            <div class="content">
                                                <h6 class="post-author-name">
                            ...
                            <div class="content-block post-list-view with-bg-solid mt--30">
                                <div class="post-thumbnail">
                                    <a href="post-details.html">
                                        <img src="assets/images/post-images/post-tech-12.jpg" alt="Post Images">
                                        <div class="review-count">
                                            <span>5</span>
                                        </div>
                                    </a>
                                ...
                                <div class="post-content">
                                    ...
                                    <h4 class="title"><a href="post-details.html">Dell XPS 15 (2020)
                                            Review: New Design, Familiar Problems</a></h4>
                                    <div class="post-meta-wrapper">
                                        <div class="post-meta">
                                            <div class="content">
                                                <h6 class="post-author-name">
                            ...
                            <div class="content-block post-list-view with-bg-solid mt--30">
                                <div class="post-thumbnail">
                                    <a href="post-details.html">
                                        <img src="assets/images/post-images/post-tech-13.jpg" alt="Post Images">
                                        <div class="review-count">
                                            <span>5</span>
                                        </div>
                                    </a>
                                ...
                                <div class="post-content">
                                    ...
                                    <h4 class="title"><a href="post-details.html">Sony’s Wf-sp800n Earbuds
                                            Are A Noise-canceling Alternative.</a></h4>
                                    <div class="post-meta-wrapper">
                                        <div class="post-meta">
                                            <div class="content">
                                                <h6 class="post-author-name">
                            ...
                            <div class="content-block post-list-view with-bg-solid mt--30">
                                <div class="post-thumbnail">
                                    <a href="post-details.html">
                                        <img src="assets/images/post-images/post-tech-14.jpg" alt="Post Images">
                                        <div class="review-count">
                                            <span>5.5</span>
                                        </div>
                                    </a>
                                ...
                                <div class="post-content">
                                    ...
                                    <h4 class="title"><a href="post-details.html">Fujifilm’s Instax Mini
                                            LiPlay brings audio to the instant camera </a></h4>
                                    <div class="post-meta-wrapper">
                                        <div class="post-meta">
                                            <div class="content">
                                                <h6 class="post-author-name">
                                ...
                                <div class="axil-single-widget widget-style-2 widget widget_post mt--30">
                                    ...
                                    <div class="video-post-wrapepr">
                                        ...
                                        <div class="content-block image-rounded">
                                            ...
                                            <div class="post-content">
                                                <h6 class="title"><a href="post-details.html">With iOS
                                                        14, Apple is finally letting the iPhone home screen get
                                                        complicated</a></h6>
                                            </div>
                                        </div>
                                        <!-- End Single Post  -->
                                        ...
                                        <div class="content-block image-rounded mt--20">
                                            ...
                                            <div class="post-content">
                                                <h6 class="title"><a href="post-details.html">A rocket
                                                        launch can’t unite us until the space world acknowledges our
                                                        divisions</a></h6>
                                            </div>
                                        </div>
                                        <!-- End Single Post  -->
                                        ...
                                        <div class="content-block image-rounded mt--20">
                                            ...
                                            <div class="post-content">
                                                <h6 class="title"><a href="post-details.html">I built my
                                                        own camera with a Raspberry Pi 4</a></h6>
                                            </div>
                                        </div>
                                        <!-- End Single Post  -->
                                    ...
                                    <div class="featured-post mt--30">
                                        <div class="content-block">
                                            <div class="post-content">
                                                ...
                                                <h4 class="title"><a href="post-details.html">Oppo Find
                                                        X2 Pro Review: Supercar Smartphone</a></h4>
                                            </div>
                                            <div class="post-thumbnail">
                                                <a href="#">
                                                    <img src="assets/images/post-single/featured-post-01.jpg"
                                    ...
                                    <div class="featured-post mt--30">
                                        <div class="content-block">
                                            <div class="post-content">
                                                ...
                                                <h4 class="title"><a href="post-details.html">The new
                                                        Moto G Stylus and G Power are surprisingly adept
                                                        cameraphones</a></h4>
                                            </div>
                                            <div class="post-thumbnail">
                                                <a href="#">
                        ...
                        <div class="col-lg-8 col-xl-8 mt--30">
                            ...
                            <div class="content-block post-list-view with-bg-solid mt--30">
                                ...
                                <div class="post-content">
                                    ...
                                    <h4 class="title"><a href="post-details.html">Sony’s Wf-sp800n
                                            Earbuds Are A Noise-canceling Alternative.</a></h4>
                                    <div class="post-meta-wrapper">
                                        <div class="post-meta">
                                            <div class="content">
                                                <h6 class="post-author-name">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="axil-banner mt--30">
                        <div class="thumbnail">
                            <a href="#">
                                <img class="w-100" src="assets/images/add-banner/banner-03.png"
                                    alt="Banner Images">
                            </a>
                        </div>
                    </div>
